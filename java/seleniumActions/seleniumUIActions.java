...
//	1 is for OR path , 2 is which key u wnat to give for xpath , 3 is value u want to enter
	...
	public static void enterValueinUI(String ORPath,String ORKey,String inputData) throws IOException
	{
		...
		logger.info("This sendkey is used for the xpath " +(readDataFromPeropertiesFile.readDataFromORProperties(ORPath,ORKey))+"and values is "+inputData);
	}
	...
	{		
		...
		logger.info("This sendkey is used for the xpath " +(ele+"and values is "+value));
	}
	...
	public static void takescreenshot(String screenshotname) throws IOException
	{
		...
		FileUtils.copyFile(file, new File("C:\\Users\\LENOVO\\eclipse-workspace\\Batch51_Automation\\batch51\\TestEvidences"+screenshotname+".png"));
